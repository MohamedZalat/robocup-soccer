...
class Supervisor(Agent):
    ...
    def __init__(self, agent, action_dict=None, model_name='krislet'):
        super().__init__()
        self._agent = agent
        ...
        # Add a stats object to record the stats of visited states and taken actions.
        self.stats = Stats(model_name)
