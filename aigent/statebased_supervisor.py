...
class StateBasedSupervisor(Supervisor):
    """
    ...
    TURN_NEG = 'turn-40'
    BALL_NOT_IN_VISION = 'ball not in vision'
    BALL_IN_VISION = 'ball in vision'
    BALL_ALIGNED = 'ball aligned'
    BALL_KICKABLE_AND_CANT_SEE_GOAL = 'ball kickable and can NOT see goal'
    BALL_KICKABLE_AND_CAN_SEE_GOAL = 'ball kickable and can see goal'
